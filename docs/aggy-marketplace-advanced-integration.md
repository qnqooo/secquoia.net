...
Current release: `1.0.0-rc.23` (`rc`, ecosystem hosted). See `aggy-release.json`, `docs/aggy-changelog.md` and `docs/aggy-versioning-policy.md`. This release candidate is prepared for production validation; it is not yet a stable-production or third-party-sale claim.
