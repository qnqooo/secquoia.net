...
test('post-payment confirmation crosses the Stripe return and is consumed only after audible Voice LIVE playback',()=>{
  ...
  assert.match(voice,/if\(!paymentGreetingAwaitingCompletion\|\|!paymentGreetingResponseCompleted\|\|!remoteAudioPlaybackStarted\|\|paymentGreetingAckInFlight\)return/);
  ...
  assert.match(market,/aggy-realtime-voice\.js\?v=1\.3\.0-rc\.2-mic-permission-20260806/);
});
