...
test('QuPay exposes only governed QVit packs',()=>{
  assert.deepEqual(Object.keys(worker.PACKS),['qvit-live-certification-1','qvit-ai-credit-25','qvit-ai-credit-100','qvit-ai-credit-500']);
  assert.equal(worker.PACKS['qvit-live-certification-1'].usdCents,100);
  assert.equal(worker.PACKS['qvit-live-certification-1'].qvitAmount,1_000_000);
